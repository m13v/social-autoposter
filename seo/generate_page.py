...
def build_cross_roundup_block(host_cfg: dict) -> str:
    ...
    return (
        ...
        "## What this page is\n\n"
        f"A balanced, objective best-of for the host's actual niche ({host_category}).\n"
        "Readers searching this query expect to see the real top players in\n"
        "this category, ranked honestly, with criteria they can verify.\n"
        "This is NOT a portfolio promo, and it is NOT an excuse to rank the\n"
        "host first on its own site.\n\n"
